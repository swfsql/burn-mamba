...
//! `serial_recalculated`; the registered autodiff [`backward`](crate::mamba3::single_ssd::ssd::serial_recalculated::backward) node and the
//! recompute-based gradient math in [`combined_backward`](crate::mamba3::single_ssd::ssd::serial_recalculated::combined_backward) save training memory
