...
use crate::dataset::{
    EVAL_SEED, Family, NUM_CLASSES, NUM_EVAL, NUM_TRAIN, ResetSwapBatch, ResetSwapBatcher,
    ResetSwapDataset, SEQ_LENGTH, TRAIN_SEED,
};
use burn::prelude::*;
use burn::{
...
type Dataloader = std::sync::Arc<dyn DataLoader<ResetSwapBatch> + 'static>;
