//! Training loop for the reset-spinor example: builds the dataloaders, runs the
...
use crate::dataset::{
    EVAL_SEED, Family, NUM_CLASSES, NUM_EVAL, NUM_TRAIN, ResetSpinorBatch, ResetSpinorBatcher,
    ResetSpinorDataset, SEQ_LENGTH, TRAIN_SEED,
};
use burn::prelude::*;
use burn::{
...
type Dataloader = std::sync::Arc<dyn DataLoader<ResetSpinorBatch> + 'static>;
